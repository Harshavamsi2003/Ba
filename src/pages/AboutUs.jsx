...
// Clinic gallery — auto-loads every image inside src/assets/about_us/gallery/,
// in numeric filename order (1.jpeg, 2.jpeg, ... 10.jpeg, ...). Drop a new
// numbered photo in that folder and it appears automatically — no code
// change needed. Matches common extensions in any case (.jpg/.JPG/.Jpeg/etc)
// since Vercel's Linux build is case-sensitive even when local Windows/Mac
// editing isn't. If the folder ever matches zero files, this logs a clear
// console warning (so it's diagnosable from DevTools) and the gallery
// section below simply doesn't render — it can no longer crash the page.
